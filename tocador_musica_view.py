...
class View(tk.Tk):
    ...
    def view_main(self):
        ...
        self.favoritar_musica_menu.add_command(label="Adicionar uma música aos favoritos", command=self.controller.favoritar_musica)
        self.favoritar_musica_menu.add_command(label="Adicionar várias as músicas aos favoritos", command=self.controller.favoritar_varias_musicas)
        ...
        self.mostrar_favoritos_verificar = Button(self, text="Mostrar músicas favoritas", command=self.controller.mostrar_favoritos, bg="#51e2f5")
